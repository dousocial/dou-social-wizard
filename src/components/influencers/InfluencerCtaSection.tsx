...
export function InfluencerCtaSection() {
  return (
    <Section spacing="md" className="relative overflow-hidden bg-ink text-paper">
      ...
      {/* Maroon ambient glow from top */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0"
        style={{
          background:
            "radial-gradient(ellipse 70% 50% at 50% 0%, rgb(128 0 0 / 0.22) 0%, transparent 65%)",
        }}
      />
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
          ...
          <div className="flex flex-col gap-4 sm:flex-row lg:col-span-5 lg:flex-col lg:items-end">
            ...
            <Reveal variant="fadeUp" delay={0.25} className="w-full sm:w-auto lg:w-full lg:max-w-xs">
              <Link
                href="/iletisim"
                className="flex w-full items-center justify-center rounded-full border border-mute-700 bg-transparent px-8 py-4 text-center font-display text-sm font-semibold tracking-wide text-paper transition-all hover:border-paper hover:bg-paper hover:text-ink"
              >
                Marka İletişimi
              </Link>
            </Reveal>
